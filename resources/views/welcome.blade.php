    ...
    <div class="landing-container">
        ...
        <section class="hero-section">
            ...
            <div class="hero-text">
                ...
                <p>Temukan laptop gaming, peripheral, dan komponen PC terbaik dengan harga yang masuk akal. Garansi
                    resmi, pengiriman aman ke seluruh Indonesia.</p>
        ...
        <section id="produk">
            <div class="section-header"
                ...
                <a href="storeDashboard.html" style="color: #6366f1; text-decoration: none; font-size: 14px;">Lihat
                    Semua &rarr;</a>
            </div>

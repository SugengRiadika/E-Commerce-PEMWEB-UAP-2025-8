...
<head>
    ...
    <style>
        ...
        .submit-btn:hover { background-color: #4f46e5 !important; transform: translateY(-2px); }
    </style>
</head>
        ...
        <main class="content-center">
            ...
            <div class="card" style="padding: 30px;">
                <div class="section-header" style="margin-bottom: 25px; border-bottom: 1px solid #374151; padding-bottom: 15px;">
                    <h3 style="color: white;"><i class="fa-solid fa-box-open" style="color: #6366f1;"></i> Upload Produk Baru</h3>
                    <p style="color: #9ca3af; font-size: 13px; margin-top: 5px;">Isi informasi produk dengan lengkap dan jelas.</p>
                </div>
                ...
                <form action="{{ route('member.mystore-m.add') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="form-group">
                        <label>Nama Produk</label>
                        <input type="text" name="name" class="form-control" placeholder="Contoh: Laptop Gaming Asus ROG" value="{{ old('name') }}" required>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="stock" class="form-control" placeholder="Contoh: 10" value="{{ old('stock') }}" required>
                        </div>
                        <div class="form-group">
                            <label>Berat (Gram)</label>
                            <input type="number" name="weight" class="form-control" placeholder="Contoh: 1000 (untuk 1kg)" value="{{ old('weight') }}" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label>Deskripsi Produk</label>
                        <textarea name="description" class="form-control" rows="5" placeholder="Jelaskan spesifikasi produk secara detail...">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="upload-area" id="uploadArea" onclick="document.getElementById('image_input').click()" style="position: relative; overflow: hidden; min-height: 200px; display: flex; align-items: center; justify-content: center; flex-direction: column; border: 2px dashed #374151; background: #111827; border-radius: 10px; cursor: pointer; transition: 0.3s;">
                            ...
                            <img id="imagePreview" src="#" alt="Preview" style="display: none; max-width: 100%; max-height: 200px; object-fit: contain; position: absolute; top:0; left: 0; width: 100%; height: 100%; background: #111827;">
                    ...
                    <div style="margin-top: 30px; display: flex; gap: 15px;">
                        <button type="submit" class="submit-btn" style="flex: 2; background: #6366f1; color: white; border: none; padding: 12px; border-radius: 50px; cursor: pointer; font-weight: 600;">

...
<body class="dashboard-body">
    ...
    <div class="seller-container">
        ...
        <div class="main-content">
            ...
            @if(session('error'))
                <div class="alert alert-success" style="background: rgba(239, 68, 68, 0.1); color: #f87171; border-color: #ef4444;">
                    <div style="display: flex; align-items: center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="4" style="text-align: center; padding: 40px;">
                                    <i class="fa-solid fa-sack-dollar" style="font-size: 40px; color: #374151; margin-bottom: 10px;"></i>
        ...
        <div class="modal-box">
            ...
            <form action="{{ route('member.balance.withdraw') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="account_number" class="form-input" placeholder="Masukkan nomor rekening" required>
                </div>
                ...
                <div style="display: flex; gap: 10px; margin-top: 25px;">
                    ...
                    <button type="submit" class="submit-btn" style="flex: 1; background: #059669; padding: 10px; font-size: 14px;">Ajukan</button>
                </div>
            </form>
        </div>
    </div>
